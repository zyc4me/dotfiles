# Generated by Powerlevel10k configuration wizard on 2020-05-14 at 00:55 CST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 28636.
# Wizard options: flat, large icons, unicode, lean, 1 line, compact, few icons, concise,
# transient_prompt.
...
() {
  ...
  typeset -g POWERLEVEL9K_MODE=flat
