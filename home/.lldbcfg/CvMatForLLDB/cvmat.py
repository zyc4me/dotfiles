...
try:
    ...
    print("Import lldb module error: {}".format(e))
    print("  Consider install it, e.g.: apt install liblldb-14 python3-lldb-14 lldb-14")
    print("  And config Python path, e.g: export PYTHONPATH=/usr/lib/llvm-14/lib/python3.8/site-packages")
